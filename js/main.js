...
document.addEventListener("click", (e) => {
    let $audio_one = document.querySelector("audio");
    let $list = document.querySelectorAll("li");
    let $list_1 = document.querySelector("ul > li:nth-child(1)");
    let $list_2 = document.querySelector("ul > li:nth-child(2)");
    let $list_3 = document.querySelector("ul > li:nth-child(3)");
    let $list_4 = document.querySelector("ul > li:nth-child(4)");
    let $list_5 = document.querySelector("ul > li:nth-child(5)");
    let $list_6 = document.querySelector("ul > li:nth-child(6)");
    let $list_7 = document.querySelector("ul > li:nth-child(7)");
    let $list_8 = document.querySelector("ul > li:nth-child(8)");
    let $list_9 = document.querySelector("ul > li:nth-child(9)");
    let $list_10 = document.querySelector("ul > li:nth-child(10)");
    let $list_11 = document.querySelector("ul > li:nth-child(11)");
    let $list_12 = document.querySelector("ul > li:nth-child(12)");
...
const audio = document.querySelector('audio'), songLength = document.getElementById('SongLength'), currentTime = document.getElementById('CurrentSongTime');
const calculateTime = (secs) => {
    const minutes = Math.floor(secs / 60), seconds = Math.floor(secs % 60), returnedSeconds = seconds < 10 ? `0${seconds}` : `${seconds}`;
...
//Audio Controls
const playPause = document.getElementById('PlayPause'), plus10 = document.getElementById('Plus10'), back10 = document.getElementById('Back10');
